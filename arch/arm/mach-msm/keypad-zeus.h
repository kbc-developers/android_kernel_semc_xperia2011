...
static struct gpio_event_direct_entry backcover_zeus_pmic_gpio_map_wake[] = {
...
static const struct gpio_event_direct_entry sim_detect_zeus_gpio_map[] = {
	{ 44, SW_JACK_PHYSICAL_INSERT},
};
